        ...
        <div className="progress_inner">
          ...
          <div className="progress_inner__tabs">
            ...
            <div className="tab tab-3">
              <h1>Decorate box</h1>
              <p>
                Choose a gift box: Select a box that suits the size and shape of
                your gift. It can be a plain cardboard box, a decorative gift
                box, or even a DIY box made from sturdy cardstock or craft
                paper.
              </p>
            </div>
            <div className="tab tab-4">
              ...
              <p>
                ...
                well-protected to prevent damage during transit. Consider using
                bubble wrap, tissue paper, or padding to safeguard fragile
                items.
              </p>
            </div>
          </div>
